...
FROM (
	SELECT country_name,weather_state,DAY FROM Weather w LEFT JOIN Countries c ON w.country_id=c.country_id
	WHERE DAY >= '2019-11-01' AND DAY < '2019-12-01'
) sub GROUP BY country_name ORDER BY country_name
